...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
			...
			"assets/images/wallpaper/d2.jpg",
			"assets/images/wallpaper/d3.jpg",
			"assets/images/wallpaper/d4.jpg",
			"assets/images/wallpaper/d5.jpg",
			"assets/images/wallpaper/d6.jpg",
			"assets/images/wallpaper/d7.jpg",
			"assets/images/wallpaper/d8.jpg",
		],
		// 移动背景图片（支持单张或多张随机）
		...
		mobile: [
			...
			"assets/images/wallpaper/m5.jpg",
			"assets/images/wallpaper/m6.jpg",
			"assets/images/wallpaper/m7.jpg",
			"assets/images/wallpaper/m8.jpg",
		],
		// 背景视频播放地址
			...
			links: [
				{
					...
					url: "https://github.com/dringsim",
					showName: true,
				},
				{
					name: "Email",
					icon: "fa7-solid:envelope",
					url: "mailto:dringsim@qq.com",
				},
				{
					name: "RSS",
					icon: "fa7-solid:rss",
